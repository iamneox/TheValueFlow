        ...
        <div class="space-y-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                    <p class="text-sm font-medium text-gray-500">Impresiones</p>
                    <p class="mt-1 text-2xl font-bold text-gray-900">{{ fmtNum(summary.impressions) }}</p>
                </div>
                <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                    ...
                    <p class="mt-1 text-2xl font-bold text-indigo-600">{{ fmt(summary.revenue) }}</p>
                </div>
            </div>

            <div class="rounded-lg border border-gray-200 bg-white shadow-sm">
                <div class="border-b border-gray-200 px-5 py-4">
                    <h2 class="font-semibold text-gray-900">Mis campañas</h2>
                </div>
